...
var DrawHelper = (function () {
    ...
    _.prototype.registerEditableShape = function (surface) {
        ...
        setListener(surface, 'mouseMove', function (position) {
            ...
            if (!surface._editMode) {
                _self._tooltip.showAt(position, "点击可以编辑这个要素");
            }
        });
        ...
        setListener(surface,'leftDoubleClick',function(position){
            // window.idZzd=surface.idZzd;
            // console.log(`${surface.typeZzd} idZzd 绘制类 ${surface.idZzd} ` )
    ...
    var defaultBillboard = {
        iconUrl: require("./img/dragIcon.png"),
        shiftX: 0,
        shiftY: 0
    }
    ...
    var dragHalfBillboard = {
        iconUrl: require("./img/dragIconLight.png"),
        shiftX: 0,
        shiftY: 0
    }
            ...
            if (position != null) {
                if (positions.length == 0) {
                    ...
                    if (cartesian) {
                        ...
                        // show tooltip
                        tooltip.showAt(position, "<p>点击添加新点 (" + positions.length + ")</p>" + (positions.length > minPoints ? "<p>双击完成绘制</p>" : ""));
                    }
                }
            }
        }, Cesium.ScreenSpaceEventType.MOUSE_MOVE);
    ...
    _.prototype.startDrawingExtent = function (options) {
        ...
        mouseHandler.setInputAction(function (movement) {
            ...
            if (position != null) {
                if (extent == null) {
                    tooltip.showAt(position, "<p>单击以开始绘制矩形</p>");
                } else {
                    var cartesian = scene.camera.pickEllipsoid(position, ellipsoid);
                    if (cartesian) {
                        ...
                        tooltip.showAt(position, "<p>拖动可更改矩形范围</p><p>再次单击以完成绘制</p>");
                    }
                }
            }
        }, Cesium.ScreenSpaceEventType.MOUSE_MOVE);
    ...
    _.DrawHelperWidget = (function () {
        ...
        function _(drawHelper, options) {
            ...
            var drawOptions = {
                markerIcon: require("./img/glyphicons_242_google_maps.png"),
                polylineIcon: require("./img/glyphicons_097_vector_path_line.png"),
                polygonIcon: require("./img/glyphicons_096_vector_path_polygon.png"),
                circleIcon: require("./img/glyphicons_095_vector_path_circle.png"),
                extentIcon: require("./img/glyphicons_094_vector_path_square.png"),
                clearIcon: require("./img/glyphicons_067_cleaning.png"),
            ...
            addIcon('marker', options.markerIcon, '点击开始绘制点', function () {
            ...
            addIcon('polyline', options.polylineIcon, '点击开始绘制线', function () {
            ...
            addIcon('polygon', options.polygonIcon, '点击开始绘制面', function () {
            ...
            addIcon('extent', options.extentIcon, '点击开始矩形', function () {
            ...
            addIcon('circle', options.circleIcon, '点击开始绘制圆', function () {
            ...
            toolbar.appendChild(div);
            addIcon('clear', options.clearIcon, '清楚所有绘制要素', function () {
